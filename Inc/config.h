...
#define BAT_DEAD                (200* BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // All leds off: undervoltage poweroff. (while not driving) [V*100/cell]. In this case 3.37 V/cell
// ######################## END OF BATTERY ###############################
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define SPEED_COEFFICIENT       16384     // 1.0f 16384
  #define STEER_COEFFICIENT       0      // 0.5f Only active in Sideboard input 8192
  ...
  #define SUPPORT_BUTTONS                      // активация кнопок выбора передач (для машин) SWCLK SWDIO
     #ifdef SUPPORT_BUTTONS                    
       #define N_Rew_Max 400                   // максимальные обороты заднего хода
       #define N_Low_Max 200                   // максимальные обороты скорость 1
       #define N_Mid_Max 600                   // максимальные обороты скорость 2
     #endif
